...
Base.show(io::IO, mime::MIME"text/plain", x::Union{TreeView, ContinuousView}) = show(io, mime, ShowArray(x))
Base.show(io::IO, x::Union{TreeView, ContinuousView}) = show(io, ShowArray(x))
