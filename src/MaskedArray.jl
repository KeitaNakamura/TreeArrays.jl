...
@inline isactive(x::MaskedArray, i::Int...) = (@_propagate_inbounds_meta; x.mask[i...])
allactive(x::MaskedArray) = all(x.mask)
anyactive(x::MaskedArray) = any(x.mask)

@inline checkmask(::Type{Bool}, x::MaskedArray, i::Int...) = (@_propagate_inbounds_meta; isactive(x, i...)) # checkbounds as well
